...
module.exports.run = async (bot, message, args) => {
  ...
  .setColor("#FFFFFF")
  .setDescription(`:negative_squared_cross_mark: You can't withdraw negative money`);
  ...
  .setColor("#FFFFFF")
  .setDescription(`:negative_squared_cross_mark: You don't have that much money in the bank`);
