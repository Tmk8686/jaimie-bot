...
module.exports.run = async (bot, message, args) => {
    ...
    if(args[0] == 'nikes') {
        ...
        .setColor("#FFFFFF")
        .setDescription(`:negative_squared_cross_mark: You don't have Nikes to sell`);
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`:negative_squared_cross_mark: You don't have a Car to sell`);
       ...
       let cars = await db.fetch(`car_${message.guild.id}_${user.id}`)
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`:negative_squared_cross_mark: You don't have a Mansion to sell`);
